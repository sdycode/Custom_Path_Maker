...
import 'package:custom_path_maker/functions/getShader.dart';
import 'package:custom_path_maker/models/PathModel.dart';
import 'package:flutter/material.dart';
import 'dart:ui' as ui;
class SingeCustomPathPainter extends CustomPainter {
  int pathNo;
  Box box;
  PathModel pathModel;
  SingeCustomPathPainter(this.pathNo, this.box, {required this.pathModel});
  ...
  void paint(Canvas canvas, Size s) {
    ...
    canvas.translate(pathModel.offsetFromOrigin.dx,
        pathModel.offsetFromOrigin.dy);
